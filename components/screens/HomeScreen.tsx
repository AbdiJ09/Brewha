        ...
        <View>
          ...
          <View className="m-5">
            <View className="flex-row items-center justify-between">
              <Text className="text-xl text-foregroundText/90 font-[Manrope-SemiBold]">
                Nearby Shop
              </Text>
              <View className="flex-row items-center">
                <Text className="mr-2 text-foregroundText/90">See All</Text>
                <ArrowRightIcon color={Colors.text} size={16} />
              </View>
            </View>
            <View>
              <Text className="text-sm text-foregroundText/50 font-[Manrope-Regular]">
                Find the best shop in your area
              </Text>
              <FlatList
                horizontal
                ...
                renderItem={({ item }) => (
                  <View className="relative p-1 mt-3 mr-2 overflow-hidden rounded-3xl bg-secondary-500">
                    ...
                    />
                    <View className="p-3">
                      <Text className="text-sm text-foregroundText/90 font-[Manrope-SemiBold]">
                        {item.name}
                      </Text>
                      <View className="flex-row items-center justify-between">
                        <View className="flex-row items-center mt-2 gap-x-1">
                          <MapPinIcon color={Colors.text} size={16} />
                        ...
                        <TouchableOpacity className="absolute flex-row items-center justify-center w-12 h-12 p-1 mt-2 rounded-full -right-3 -bottom-3 gap-x-1 bg-primary-500">
                          <ArrowUpRightIcon color={Colors.text} size={16} />
                        </TouchableOpacity>
                      </View>
                    </View>
                  </View>
              ...
              renderItem={({ item }) => (
                <View className="relative p-1 mt-3 mr-2 overflow-hidden rounded-3xl bg-secondary-500">
                  <Image
                    ...
                    className="w-40 h-32 rounded-3xl"
                  />
                  <Text className="p-3 text-sm text-foregroundText/90 font-[Manrope-SemiBold]">
                    {item.title}
                  </Text>
                </View>
              )}
