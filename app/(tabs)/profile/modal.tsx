...
const uploadImage = async (user: any, base64: string) => {
...
const Modal = () => {
  ...
  const mutation = useMutation({
    mutationFn: (base64: string) => uploadImage(user, base64),
    onSuccess: () => {
  ...
  return (
    <View style={styles.wrapper}>
      {/* Wrap the animated content in a static View */}
            ...
            <View style={styles.controlsContainer}>
              {isPreview ? (
                ...
                <View style={styles.cameraControls}>
                  ...
                  <Animated.View
                    style={[styles.shutterContainer, shutterAnimatedStyle]}
                  >
                    <TouchableOpacity
